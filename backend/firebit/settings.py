"""
Django settings for firebit project.
...
SECRET_KEY = 'django-insecure-2nltt0nsep5@6a8+^6t9nv^xx5t-9^0sim=5elyp_^kr5n1w0!'
...
WSGI_APPLICATION = 'firebit.wsgi.application'
